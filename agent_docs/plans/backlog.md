...
2. CLI Operator Dry-Run And Apply Loop
- Type: `feature`
...
3. Real-Notes MVP Smoke Scenario Pack
- Type: `feature`
...
6. Workflow Apply Response Action Echo
- Type: `hardening`
...
7. Policy Identity Plumbing Spec Without `any_instance`
- Type: `hardening`
